    ...
    return (
        <FooterSectionStyled className='u-pad-lg-2' theme={theme}>
            <nav className="bottom-navigation">
                <ul className="logo-con">
                    ...
                    <div className="b-nav-icons">
                        <a class="fab fa-facebook" href='https://www.facebook.com/abir.beatz.1'></a>
                        <a class="fab fa-linkedin" href='https://www.linkedin.com/in/abir-k/'></a>
                        <a class="fab fa-github" href='https://github.com/Abir-K'></a>
            ...
            <div className="footer-copywrite">
                <p>
                    Copyright © 2022 <span>Company Profile</span>. All rights reserved.
                </p>
            </div>
        </FooterSectionStyled>
    )
